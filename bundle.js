...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      data.map(function (dataUnit) {
	        return React.createElement(dataUnit.klass, { data: dataUnit.value, key: dataUnit.key });
	      })
	    );
	  }
	});
	...
	function someData() {
	  return shuffle([{ klass: Comment,
	    value: 5, key: 1 }, { klass: Comment, value: 4, key: 2 }, { klass: Comment,
	    value: "**bold** move", key: 3 }, { klass: Comment, value: 3, key: 4 }, { klass: Comment, key: 5,
	    value: ((new Date().getTime() - start) / 1000).toFixed() }]);
	}
	setInterval(function () {
	  ReactDOM.render(ListComponentFactory({ containerTag: 'div', data: someData() }), document.getElementById('list'));
	}, 500);
